...
└─────────────┘                └─────────────────┘                │    CI/CD        │
                                                                  └─────────────────┘
                                                                           ...
                                                                           ▼
┌─────────────┐    HTTPS      ┌─────────────────┐    proxies     ┌─────────────────┐
│Global Users │ ◄─────────────│ Custom Domain   │ ◄──────────────│   AWS S3 Bucket │
└─────────────┘               │static.kalra1994.│                │   Static Website│
                              │     co.in       │                └─────────────────┘
                              └─────────────────┘                           ▲
                                       ▲                                    │
                                       │ serves                             │
                              ...
                              │   SSL + Edge    │                │ Host Header Fix │
                              └─────────────────┘                └─────────────────┘
```

**Flow**: `Developer → GitHub → Actions → S3 → Worker → CDN → Domain → Users`
